  ...
  <footer class="border-t bg-gray-50 dark:bg-gray-900">
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div class="space-y-4">
          <div class="flex items-center space-x-2">
            ...
            <span class="font-bold text-lg">Thịnh Hưng Phát</span>
          </div>
          <p class="text-sm text-muted-foreground">
            Chuyên cung cấp than đá chất lượng cao, uy tín, giá cả hợp lý.
          </p>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2 text-sm">
            <li>
              <NuxtLink to="/about" class="text-muted-foreground hover:text-primary">
                Giới thiệu
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/products" class="text-muted-foreground hover:text-primary">
                Sản phẩm
              </NuxtLink>
            </li>
                  <li>
            ...
            <li>
              <NuxtLink to="/contact" class="text-muted-foreground hover:text-primary">
                Liên hệ
              </NuxtLink>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul class="space-y-3 text-sm">
            <li class="flex items-center space-x-3">
              ...
              <span class="text-muted-foreground">info@thinhungphat.com</span>
            </li>
            <li class="flex items-center space-x-3">
              <div class="flex-shrink-0 w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                <svg class="h-5 w-5 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2.5">
              ...
              <span class="text-muted-foreground">0123 456 789</span>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div class="flex space-x-3">
            <a href="#" class="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center text-muted-foreground hover:text-primary hover:bg-primary/20 transition-colors">
      ...
      <div class="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
        <p>&copy; {{ new Date().getFullYear() }} Thịnh Hưng Phát. All rights reserved.</p>
      </div>
    </div>
  </footer>
</template>
